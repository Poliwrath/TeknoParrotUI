...
namespace TeknoParrotUi.Views
{
    ...
    public partial class Library
    {
        ...
        private void ListBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            //EmulationProfile
            var gameInfo = $"{Properties.Resources.LibraryEmulator}: {selectedGame.EmulatorType} ({(selectedGame.Is64Bit ? "x64" : "x86")})\n";
#if DEBUG
            gameInfo += $"Profile: {selectedGame.EmulationProfile}\n";
#endif
            gameInfo += $"{(selectedGame.GameInfo == null ? Properties.Resources.LibraryNoInfo : selectedGame.GameInfo.ToString())}";
